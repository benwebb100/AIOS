...
- **Monthly retainer:** $1,000/mo founding, then $2,000–3,000/mo
...
## Tech Stack (What Bailey Uses to Deliver)
- **Claude Code** — the core tool, both for Bailey's own work and for client AIOS setups
- **Obsidian** — persistent knowledge base for each client's business context
- **MCP Servers** — connect Claude Code to client tools (CRM, email, calendar, analytics, etc.)
